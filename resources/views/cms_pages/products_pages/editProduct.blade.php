...
@section("nav_subTitle","تعديل منتج")
@section("content")
@if ($errors->any())
<div class="error">
    <ul>
...
@endif
    <form action="{{route("Products.update",$product->id)}}" method="post">
      ...
      <input type="text" id="p_name" name="p_name" placeholder="إدخل اسم المنتج" value="{{$product->name}}">
      <label for="p_price">سعر المنتج</label>
      <input type="text" id="p_price" name="p_price" placeholder="إدخل سعر المنتج" value="{{$product->price}}">
